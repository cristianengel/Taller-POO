...
public class Main {
    public static void main(String[] args) {
        ...
        b.agregarEjemplar(new Ejemplar("ident1213", 135441, "caca", "matematica", new ArrayList<String>(), LocalDate.of(2022, 11, 3), "qsy", "qsyyyyy", LocalDate.of(2021, 7, 23), "jdfhe", new Obra("lunes", "nashee", "kjhfasjk", "yo", "papa", "mama", "masc dea", "oiejfiujsdhfufnsdf", 14143, "rtrtgfrtgr")));
        b.agregarEjemplar(new Ejemplar("ident45", 135441, "caca", "matematica", new ArrayList<String>(), LocalDate.of(2022, 11, 3), "qsy", "qsyyyyy", LocalDate.of(2021, 7, 23), "jdfhe", new Obra("lunes", "nashee", "kjhfasjk", "yo", "papa", "mama", "masc dea", "oiejfiujsdhfufnsdf", 14143, "ateatrgtregega")));
