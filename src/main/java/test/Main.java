...
public class Main {
    public static void main(String[] args) {
        ...
        Obra elPrincipe = new Obra("Politica", "El Pincipe", "",
                "Nicolas Maquiavelo", "", "", "Ensayo",
                "Su tema central es cómo los gobernantes del Renacimiento deberían actuar para " +
                        "prevalecer. Según el autor, un Estado fuerte requiere un líder capaz de defender su poder " +
                        "a toda costa.",  "\"\\n\" + \"El príncipe\\n\" + \"\\n\" + \"Capítulo I\\n\" + " +
                "\"\\n\" + \"Cuántas clases de principados hay, y de qué modo ellos se adquieren\\n\" + \"Capítulo " +
                "II\\n\" + \"\\n\" + \"De los príncipes hereditarios\\n\" + \"Capítulo III\\n\" + \"\\n\" + \"De los " +
                "principados mixtos\\n\" + \"Capítulo IV\\n\" + \"\\n\" + \"Por qué ocupado el reino de Darío por " +
                "Alejandro, no se rebeló contra los sucesores de éste después de su muerte\\n\" + \"Capítulo V\\n\" " +
                "+ \"\\n\" + \"De qué modo deben gobernarse las ciudades o principados que, antes de ocuparse por un " +
                ...
                " eclesiásticos\\n\" + \"Capítulo XII\\n\" + \"\\n\" + \"Cuántas especies de tropas hay; y de los" +
                " soldados mercenarios\\n\" + \"Capítulo XIII\\n\" + \"\\n\" + \"De los soldados auxiliares, mixtos" +
                " y propios\\n\" + \"Capítulo XIV\\n\" + \"\\n\" + \"De las obligaciones del príncipe en lo concerniente" +
                " al arte de la guerra\\n\" + \"Capítulo XV\\n\" + \"\\n\" + \"De las cosas por las que los hombres, y" +
                " especialmente los príncipes, son alabados o censurados\\n\" + \"Capítulo XVI\\n\" + \"\\n\" + \"De la" +
                " liberalidad y miseria (avaricia)\\n\" + \"Capítulo XVII\\n\" + \"\\n\" + \"De la severidad y clemencia," +
                " y si vale más ser amado que temido\\n\" + \"Capítulo XVIII\\n\" + \"\\n\" + \"De qué modo los príncipes" +
                " deben guardar la fe dada\\n\" + \"Capítulo XIX\\n\" + \"\\n\" + \"El príncipe debe evitar ser" +
                " despreciado y aborrecido\\n\" + \"Capítulo XX\\n\" + \"\\n\" + \"Si las fortalezas y otras muchas" +
                " cosas que los príncipes hacen con frecuencia son útiles o perniciosas\\n\" + \"Capítulo XXI\\n\" + " +
                ...
                " qué muchos príncipes de Italia perdieron sus estados?\\n\" + \"Capítulo XXV\\n\" + \"\\n\" + \"Cuánto" +
                " dominio tiene la fortuna en las cosas humanas, y de qué modo podemos resistirle cuando es " +
                "contraria\\n\" + \"Capítulo XXVI\\n\" + \"\\n\" + \"Exhortación a librar la Italia de los bárbaros\"");
        Obra principiosSistemasDeInformacion = new Obra("Administracion", "Principios de " +
                "sistemas de informacion: un enfoque administrativo(9ed.)", "", "Ralph M. Stair",
                "George W. Reynolds", "", "Didactico",
                "Los autores presentan" +
                        " una visión global y el marco teórico de las versiones anteriores, pero con información actual, " +
                        "ejemplos y estudios de caso. A lo largo del desarrollo de los temas se cubren los principios básicos" +
                        " de los sistemas de información y su aplicación en el mundo real.",
        ...
        Obra sistemasAdSistemasInf = new Obra("Administracion",
                "Sistemas administrativos y sistemas de información", "",
                "Jorge Roberto Volpentesta", "", "", "Didactico",
                "Este libro habla del conocimiento y de los elementos que lo nutren: los datos y la " +
                        "información. Pero lo hace desde una mirada dirigida a la gestión de las organizaciones " +
                        "y, dentro de ellas, las empresas en especial. Y si de gestión empresaria se trata, a " +
                        "ésta fácilmente puede asociársela con muchas acciones que están dirigidas a disminuir el" +
                        " riesgo del que habla el autor citado, cuyo pensamiento expone que ese riesgo deviene de " +
                        "un equilibrio dinámico entre poseer o no el conocimiento.",
                "Introducción\n" + "\n" + "Capítulo 1. Datos, información y conocimiento\n" +
                        "\n" + "Capítulo 2. Conceptos sobre sistemas\n" + "\n" + "Capítulo 3. La organización como" +
        ...
        Ejemplar principe1 = new Ejemplar("klhHlho", 1354414,
                "Su tema central es cómo los gobernantes del Renacimiento deberían actuar" +
                        " para prevalecer. Según el autor, un Estado fuerte requiere un líder capaz" +
                        " de defender su poder a toda costa.",
                new ArrayList<String>(Arrays.asList("2", "12", "32")), LocalDate.of(2022, 8, 26),
                "Compra a biblioteca Y", elPrincipe);
        Ejemplar principiosSistemasDeInformacion1 = new Ejemplar("peoNSWe", 8736245, "",
                new ArrayList<String>(Arrays.asList("1", "34", "6")), LocalDate.of(2020, 1, 24),
                "Compra por Internet", principiosSistemasDeInformacion);
        ...
        Ejemplar sistemasAdSistemasInf1 = new Ejemplar("kQbfGG", 2451442, "",
                new ArrayList<String>(Arrays.asList("3", "23", "43")), LocalDate.of(2021, 6, 20),
                "Compra a biblioteca X",  sistemasAdSistemasInf);
